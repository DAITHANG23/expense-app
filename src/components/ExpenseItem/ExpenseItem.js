...
const ExpenseItem = (props) => {
  ...
  const month = new Date(createTime).toLocaleString("en-US", { month: "long" });
  const date = new Date(createTime).toLocaleString("en-US", { day: "2-digit" });
    ...
    <div className="expense-item">
      ...
      <div className="editing">
        ...
        <button
          ...
          type="button"
          className=" btn-danger btn rounded-circle"
          aria-label="Close"
          style={{
            height: "45px",
          }}
